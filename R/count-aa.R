...
#'
#' @description This function creates a list or data frame that contains the number of each of the 20 amino acids that can be found in a provided fasta file.
#'
...
#'
#' @return If df=FALSE: a list of 20 integers, each representing the total number of an amino acid in the protein.
#' If df=TRUE: a data frame with 20 rows, each containing the total number of an amino acid in the protein.
#' @export
#'
...
count.aa <- function(file, df=FALSE) {
